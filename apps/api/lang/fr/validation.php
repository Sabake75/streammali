...
/*
 * Traduction française des messages de validation par défaut de Laravel
 * (mêmes clés que vendor/laravel/framework/.../lang/en/validation.php).
 * APP_LOCALE=fr et APP_FALLBACK_LOCALE=fr sur Render (voir render.yaml) :
 * sans ce fichier, aucune des deux locales ne résout la traduction et
 * l'utilisateur voit la clé brute ("validation.uploaded") au lieu d'un
 * message — repéré en conditions réelles sur /inscription-createur
 * (pièce d'identité trop volumineuse pour PHP → règle implicite
 * "uploaded", jamais explicitement écrite dans nos propres validations).
 */
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute donné figure dans une fuite de données connue. Merci de choisir un autre :attribute.',
    ],
    ...
    'uploaded' => "Le fichier du champ :attribute n'a pas pu être envoyé (probablement trop volumineux).",
    ...
    /*
     * Noms de champs lisibles pour les formulaires réellement exposés par
     * l'API (voir routes/api.php) — sans ça, les messages ci-dessus
     * afficheraient "phone"/"identity_document" tels quels.
     */
    'attributes' => [
        'name' => 'nom',
        'phone' => 'téléphone',
        ...
        'terms_accepted' => 'acceptation des CGU',
        'title' => 'titre',
        'description' => 'description',
        'category' => 'catégorie',
        'price' => 'prix',
        'duration_seconds' => 'durée',
        'poster_path' => 'jaquette',
        'rating' => 'note',
        'comment' => 'commentaire',
        'reason' => 'motif',
        'body' => 'message',
        'amount' => 'montant',
        'destination_msisdn' => 'numéro Mobile Money',
        'payer_msisdn' => 'numéro Mobile Money',
        'creator_id' => 'créateur',
        'search' => 'recherche',
        'sort' => 'tri',
    ],
