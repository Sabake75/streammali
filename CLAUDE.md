...
- `apps/api` : scaffold Laravel initialisé et fonctionnel sur PostgreSQL (migrations par défaut exécutées). Reste à faire : structure de domaines métier (`Domain/*`), back-office Filament, intégration Orange Money.
